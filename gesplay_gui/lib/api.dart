...
class ApiEndpoints {
  ...
  static const SET_CURRENT_GAME = 'set-current-game';
}
...
class Api {
  ...
  static Future<Map<String, dynamic>> setCurrentGame(String gameName) async {
    return Api.post(ApiEndpoints.SET_CURRENT_GAME, body: {'game': gameName});
  }
